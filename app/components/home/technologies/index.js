...
export default function Technologies({intl}) {
            ...
            <div className='pt-22    md:pt-28  flex flex-col justify-between'>
                <div className='pt-32  flex flex-col items-start justify-start'>
                    <div className='flex md:flex-row flex-col text-start items-start md:items-center  justify-between md:gap-0 gap-2'>
                        ...
                        <h2 className=' font-bold text-3xl md:text-6xl  text-slate-900 md:w-1/3 leading-tight '>{intl["technologies"].title}</h2>
                        <p className='text-slate-600 font-rubik font-normal text-sm md:text-base md:w-1/3  '>{intl["technologies"].description}</p>
                    </div>
                </div>
