...
const Footer = () => {
    ...
    return (
        <Element name="contact" className="element">
            ...
            <div className='w-full bg-[#201F1F] p-5 mt-10'>

                <div className='max-w-6xl mx-auto flex flex-col items-center justify-center '>
                    <form className='mb-10 w-[600px] items- flex flex-col justify-center' onSubmit={handleSubmit}>
                        <h3 className='text-white font-syne text-[48px] font-bold '>Let`s talk!</h3>
                        <p className='font-syne text-[14px] font-normal text-white/70 mb-3  '>Lt's discuss what you need and how we can help you!</p>
                        <div className="mb-6">
                            <input type="text" onChange={handleChange} value={form.name} name='name' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full p-5 dark:bg-gray-700 dark:border-gray-600  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:text-white placeholder:font-rubik placeholder:font-normal" placeholder="Your Name*" />
                        </div>
                        <div className="mb-6">
                            <input type="email" onChange={handleChange} value={form.email} name="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full p-5 dark:bg-gray-700 dark:border-gray-600  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:text-white placeholder:font-rubik placeholder:font-normal" placeholder="Your Email*" />
                        </div>
                        <div className="mb-6">
                            <textarea placeholder='How can we help?*' onChange={handleChange} value={form.message} name="message" rows="4" cols="50" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-5 dark:bg-gray-700 dark:border-gray-600  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:text-white placeholder:font-rubik placeholder:font-normal">

                            </textarea>
                        </div>
                        <div className="mb-6 space-y-4">
                            <div className='w-full flex items-center justify-between'>
                                <h3 className='text-white font-rubik font-bold text-[20px]'>Project Budget</h3>
                                <p className='text-white font-rubik font-normal text-[16px]'>

                                    ${value[0]} - ${value[1]}   {value[1] == 100000 && "+"}
                                </p>
                            </div>
                            <Box sx={{ width: "100%" }}>
                                <Slider
                        ...
                        <button type='submit' className=' text-black font-rubik text-[16px] font-bold rounded-[32.5px] bg-white py-6 px-10 mt-6 tracking-[1.625px] uppercase'>submit</button>
                    </form>
                    <div className='flex items-center justify-between w-full'>
                        ...
                        {/* <p className='font-bold text-[16px] font-syne text-white '>Privacy Policy</p> */}
                    </div>
                </div>
            </div>
        </Element>
